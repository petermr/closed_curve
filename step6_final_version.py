"""Step 6: Final version - circle start, inward progression, human-like error, no crossings, up to 100 curves."""
...
def main():
    st.title("Step 6: Final Nested Curves Generator")
    st.write("Circle start, inward progression, human-like error, no crossings, up to 100 curves")
    ...
    # Generate curves
    if st.button("Generate Final Nested Curves"):
        ...
        # Display image
        st.image(image, caption=f"Generated {num_curves} Final Nested Curves", use_container_width=True)
        ...
        with col1:
            ...
            png_filename = f"step6_final_curves_{num_curves}_len{segment_length}_error{variation_amount}.png"
        ...
        with col2:
            ...
            svg_filename = f"step6_final_curves_{num_curves}_len{segment_length}_error{variation_amount}.svg"
